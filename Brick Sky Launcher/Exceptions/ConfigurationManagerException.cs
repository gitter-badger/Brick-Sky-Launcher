...
{
    /// <summary>
    ///     This <see cref="Exception" /> is thrown on configuration errors.
    /// </summary>
    [Serializable]
    public sealed class ConfigurationManagerException : Exception
    {
        /// <summary>
        ...
        /// </param>
        public ConfigurationManagerException(string message, Exception innerException) : base(message, innerException)
        {
        }
        ...
        /// </exception>
        private ConfigurationManagerException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
    }
}